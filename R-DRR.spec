...
Version  : 0.0.4
Release  : 38
URL      : https://cran.r-project.org/src/contrib/DRR_0.0.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/DRR_0.0.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589582919
